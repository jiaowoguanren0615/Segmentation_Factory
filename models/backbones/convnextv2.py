...
class ConvNeXtV2(nn.Module):
    ...
    def __init__(self, in_chans=3, 
        ...
        for i in range(4):
            self.add_module(f"norm{i}", LayerNorm(dims[i], data_format="channels_first"))
...
def convnextv2_atto(**kwargs):
    ...
    model = ConvNeXtV2(depths=[2, 2, 6, 2], dims=[40, 80, 160, 320], drop_path_rate=0.0, **kwargs)
    return model
...
def convnextv2_femto(**kwargs):
    ...
    model = ConvNeXtV2(depths=[2, 2, 6, 2], dims=[48, 96, 192, 384], drop_path_rate=0.0, **kwargs)
    return model
...
def convnext_pico(**kwargs):
    ...
    model = ConvNeXtV2(depths=[2, 2, 6, 2], dims=[64, 128, 256, 512], drop_path_rate=0.0, **kwargs)
    return model
...
def convnextv2_nano(**kwargs):
    ...
    model = ConvNeXtV2(depths=[2, 2, 8, 2], dims=[80, 160, 320, 640], drop_path_rate=0.0, **kwargs)
    return model
...
def convnextv2_tiny(**kwargs):
    ...
    model = ConvNeXtV2(depths=[3, 3, 9, 3], dims=[96, 192, 384, 768], drop_path_rate=0.1, **kwargs)
    return model
...
def convnextv2_base(**kwargs):
    ...
    model = ConvNeXtV2(depths=[3, 3, 27, 3], dims=[128, 256, 512, 1024], drop_path_rate=0.4, **kwargs)
    return model
...
def convnextv2_large(**kwargs):
    ...
    model = ConvNeXtV2(depths=[3, 3, 27, 3], dims=[192, 384, 768, 1536], drop_path_rate=0.5, **kwargs)
    return model
...
def convnextv2_huge(**kwargs):
    ...
    model = ConvNeXtV2(depths=[3, 3, 27, 3], dims=[352, 704, 1408, 2816], drop_path_rate=0.5, **kwargs)
    return model
