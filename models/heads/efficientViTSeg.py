...
from models.backbones import EfficientViTBackbone, EfficientViTLargeBackbone
...
def efficientvit_seg_b0(dataset: str, **kwargs) -> EfficientViTSeg:
    from models.backbones import efficientvit_backbone_b0
...
def efficientvit_seg_b1(dataset: str, **kwargs) -> EfficientViTSeg:
    from models.backbones import efficientvit_backbone_b1
...
def efficientvit_seg_b2(dataset: str, **kwargs) -> EfficientViTSeg:
    from models.backbones import efficientvit_backbone_b2
...
def efficientvit_seg_b3(dataset: str, **kwargs) -> EfficientViTSeg:
    from models.backbones import efficientvit_backbone_b3
...
def efficientvit_seg_l1(dataset: str, **kwargs) -> EfficientViTSeg:
    from models.backbones import efficientvit_backbone_l1
...
def efficientvit_seg_l2(dataset: str, **kwargs) -> EfficientViTSeg:
    from models.backbones import efficientvit_backbone_l2
...
#     from models.layers.ops import resize
#     model = efficientvit_seg_b0(dataset='cityscapes')
#     x = torch.randn(1, 3, 512, 512)
#     y = model(x)
#     print('God Bless Me')
#     print(x.shape[:2])
#     print(y.shape)
#     y = resize(y, size=x.shape[2: ])
#     print(y.shape)
#     print('==>Pass!')