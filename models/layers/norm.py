...
from models.layers.initialize import build_kwargs_from_config
...
def reset_bn(
    ...
    from models.layers.dist import AverageMeter, is_master, sync_tensor
    from models.layers import list_join
